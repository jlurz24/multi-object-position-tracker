"""autogenerated by genpy from position_tracker/InitActionResult.msg. Do not edit."""
import sys
...
class InitActionResult(genpy.Message):
  ...
  _type = "position_tracker/InitActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','position_tracker/InitResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = position_tracker.msg.InitResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = position_tracker.msg.InitResult()
